    ...
    const navigationsConnected = [
        {
            ...
            desc: "Explorez les racines de votre famille et construisez votre histoire personnelle.",
            href: "/family-tree"
        }
    ];
            ...
            <div className="max-w-screen-xl mx-auto px-4 flex items-center justify-start h-screen md:px-8">
                <div className="max-w-lg mx-auto text-gray-600">
                    <div className="space-y-3 text-center">
                        ...
                        <p className="text-sm">
                            Félicitations ! Votre demande a été traitée avec succès et est en cours de vérification.
                        </p>
                    </div>
                    <div className="mt-12">
